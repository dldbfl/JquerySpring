				...
				<div class="card card-outline card-info">
					...
					<div class="card-body">
						<form enctype="multipart/form-data" role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
							  		<input type='hidden' name='pno' id='pno' value ="${pds.pno}">							  		
							</div>
									...
									<div class="card-footer fileInput">
										<div class="inputRow" >
											<c:forEach items="${pds.attachList }" var="AttachVO">
												<input type=button name="uploadFile" style="display: inline;" value="파일 변경" name='${pds.attachList }' id='${pds.attachList }'>${AttachVO.fileName }
												<button id = "delete" style="border:0;outline:0;" class="badge bg-red" type="button">X</button><br/>
											</c:forEach>
										</div>								
									</div>
								</div>
